...
void test_lazy_seq() {
    ...
    auto fib1_ptr = fib1;
    Sequence<long long>* a = new Vector_Sequence<long long>;
    for (int i = 0; i < 2; ++i) {
        a->append(i);
    }
...
void test_static_gen() {
    Sequence<int>* a = new Vector_Sequence<int>;
    for (int i = 0; i <= 10; ++i) {
        a->append(i);
    }
...
void test_append() {
    ...
    Sequence<int>* b = new Vector_Sequence<int>;
    for (int i = 11; i <= 20; ++i) {
        b->append(i);
    }
